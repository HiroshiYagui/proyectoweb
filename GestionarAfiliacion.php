                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    ...
                                    <a href="AgregarAfiliacion.php"><i class="zmdi zmdi-plus"></i>Agregar Afiliacion</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive table--no-card m-b-30">
                    ...
                    if(isset($_SESSION['user'])){
                        ...
                        <tr>
                            ...
                            <th>RUC</th>
                            <th>Empresa</th>
                            <th class='text-right'>Fecha Vigencia</th>
                            <th class='text-right'>Fecha Expiración</th>
                        ...
                        for ($i=0; $i <$num_resultados; $i++) {
                            ...
                            echo "
                                ...
                                <td class='text-right'>".$row['fechav']."</td>
                                <td class='text-right'>".$row['fechae']."</td>
